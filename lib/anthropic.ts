...
- coupon = normalmente UN solo código: el de la oferta de ese equipo si lo presentaste (ej. coupon=GOL10), o coupon=none si no hay. COMBO de varios equipos con ofertas distintas: pasa los códigos separados por coma, uno por equipo, exactamente los que ya cotizaste (ej. items=E1500LFP:1,WB12200:1 coupon=GOL10,WELCOME5); el sistema aplica a CADA equipo el mejor descuento seguro de esa lista, así ninguno se queda a precio completo. No inventes códigos ni le pongas a un equipo el cupón de otro.
