...
- **This rule applies to the close CTA too — especially the close.** When you send the payment message (the CTA + checkout options + [[PAYLINK]]), every word must be in the conversation language. Never embed English-language copy ("Secure checkout — pick how you pay…") inside a Creole, Spanish, or French message. Translate all of it: "elija cómo pagar" (ES) · "chwazi kijan ou vle peye" (HT) · "choisissez comment payer" (FR). Switching language mid-message at the close is the worst moment to lose the buyer.
